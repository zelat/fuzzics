...
class IEC104(IFuzzer):
    ...
    def get_requests() -> List[callable]:
        return [IEC104.iec104_startdt, IEC104.iec104_apci_empty, IEC104.iec104_clock_sync, IEC104.iec104_inter_command, IEC104.other_operations]
    ...
    def define_nodes(*args, **kwargs) -> None:
        ...
        s_initialize("iec104_apci_empty")
        with s_block("iec_apci"):
            s_byte(0x68, name="start", fuzzable=False)
            s_byte(0x04, name="apdu_length", fuzzable=False)
    ...
    @staticmethod
    def iec104_apci_empty(session: Session) -> None:
        session.connect(s_get('iec104_apci_empty'))
